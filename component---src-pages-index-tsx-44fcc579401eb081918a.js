...
/***/ (function(module, exports, __webpack_require__) {
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement("div", null, React.createElement("div", { className: "background-image cold-desert", style: { opacity: backgroundStyle === "cold-desert" ? 1 : 0 } }), React.createElement("div", { className: "background-image desert", style: { opacity: backgroundStyle === "desert" ? 1 : 0 } }), React.createElement("div", { className: "background-image half-desert", style: { opacity: backgroundStyle === "half-desert" ? 1 : 0 } }), React.createElement("div", { className: "background-image steppe", style: { opacity: backgroundStyle === "steppe" ? 1 : 0 } }), React.createElement("div", { className: "background-image forest-steppe", style: { opacity: backgroundStyle === "forest-steppe" ? 1 : 0 } }), React.createElement("div", { className: "background-image rainforest", style: { opacity: backgroundStyle === "rainforest" ? 1 : 0 } }), React.createElement("div", { className: "background-image forest", style: { opacity: backgroundStyle === "forest" ? 1 : 0 } }), React.createElement("div", { className: "background-image wetland", style: { opacity: backgroundStyle === "wetland" ? 1 : 0 } }), React.createElement("h1", null, "Input Data"), React.createElement("div", { className: "group-of-cards" }, React.createElement(TerritoryInput_1.default, { territory: this.state.territory, onInput: function onInput(event) {
...
//# sourceMappingURL=component---src-pages-index-tsx-44fcc579401eb081918a.js.map