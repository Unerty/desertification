...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Header = function Header(props) {
	    ...
	    return React.createElement("div", { className: "header" }, React.createElement("h1", null, "\u0420\u0438\u0437\u0438\u043A: ", risk, ", \u0411\u0456\u043E\u043C: ", biome));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AbsoluteHumidity = function AbsoluteHumidity(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u0410\u0431\u0441\u043E\u043B\u044E\u0442\u043D\u0430 \u0432\u043E\u043B\u043E\u0433\u0456\u0441\u0442\u044C: ", React.createElement("strong", null, " ", props.absoluteHumidity, " \u0433/\u043C\xB3")));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HumidificationIndex = function HumidificationIndex(props) {
	    return React.createElement("div", { className: "rounded card" }, React.createElement("span", null, "\u0406\u043D\u0434\u0435\u043A\u0441 \u0437\u0432\u043E\u043B\u043E\u0436\u0435\u043D\u043D\u044F: ", React.createElement("strong", null, " ", props.humidificationIndex, " ")));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelativeHumidity = function RelativeHumidity(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u0412\u0456\u0434\u043D\u043E\u0441\u043D\u0430 \u0432\u043E\u043B\u043E\u0433\u0456\u0441\u0442\u044C: ", React.createElement("strong", null, " ", props.relativeHumidity, "%")));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Volatility = function Volatility(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u0412\u0438\u043F\u0430\u0440\u043E\u0432\u0443\u0432\u0430\u043D\u0456\u0441\u0442\u044C: ", React.createElement("strong", null, " ", props.volatility == 1 ? 0 : props.volatility, " \u043C\u043C/\u0440\u0456\u043A")));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WaterIncome = function WaterIncome(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u041F\u0440\u0438\u0445\u0456\u0434 \u0432\u043E\u0434\u0438: ", React.createElement("strong", null, " ", props.waterIncome, " \u043C\u043C/\u0440\u0456\u043A")));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AdditionalWateringInput = function AdditionalWateringInput(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u0414\u043E\u0434\u0430\u0442\u043A\u043E\u0432\u0435 \u043E\u0440\u043E\u0448\u0435\u043D\u043D\u044F: ", React.createElement("strong", null, " ", props.additionalWatering, " \u043A\u043C\xB3/\u0440\u0456\u043A")), React.createElement("input", { style: { borderStyle: "unset", borderRadius: "10px" }, type: "number", id: "additionalWateringSelector", name: "additionalWateringSelector", min: "0", step: "1", value: props.additionalWatering, onInput: function onInput(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CactooAmountInput = function CactooAmountInput(props) {
	    return React.createElement("div", { className: "rounded card cactoo-color" }, React.createElement("span", null, "\u041A\u0456\u043B\u044C\u043A\u0456\u0441\u0442\u044C \u043A\u0430\u043A\u0442\u0443\u0441\u0456\u0432: ", React.createElement("strong", null, " ", props.cactooAmount)), React.createElement("input", { style: { borderStyle: "unset", borderRadius: "10px" }, type: "number", id: "cactooAmountSelector", name: "cactooAmountSelector", min: "0", step: "1", value: props.cactooAmount, onInput: function onInput(event) {
	            return props.onInput(event);
	        }, onChange: function onChange(event) {
	            return props.onInput(event);
	        } }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PrecipationInput = function PrecipationInput(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u041E\u043F\u0430\u0434\u0438: ", React.createElement("strong", null, " ", props.precipation, " \u043C\u043C/\u0440\u0456\u043A")), React.createElement("input", { style: { borderStyle: "unset", borderRadius: "10px" }, type: "number", id: "precipationSelector", name: "precipationSelector", min: "0", step: "1", value: props.precipation, onInput: function onInput(event) {
	            return props.onInput(event);
	        }, onChange: function onChange(event) {
	            return props.onInput(event);
	        } }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TemperatureInput = function TemperatureInput(props) {
	    return React.createElement("div", { className: "rounded card" }, React.createElement("span", null, "\u0421\u0435\u0440\u0435\u0434\u043D\u044C\u043E\u0440\u0456\u0447\u043D\u0430 \u0442\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430: ", React.createElement("strong", null, " ", props.temperature, " \xB0C")), React.createElement("input", { style: { width: "max-content" }, type: "range", id: "temperatureSelector", name: "temperatureSelector", min: "-25", max: "70", step: "1", onInput: function onInput(event) {
	            return props.onInput(event);
	        }, onChange: function onChange(event) {
	            return props.onInput(event);
	        } }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TerritoryInput = function TerritoryInput(props) {
	    return React.createElement("div", { className: "rounded card" }, React.createElement("span", null, "\u041F\u043B\u043E\u0449\u0430 \u0442\u0435\u0440\u0438\u0442\u043E\u0440\u0456\u0457: ", React.createElement("strong", null, " ", props.territory, " \u043A\u043C\xB2")), React.createElement("input", { style: { borderStyle: "unset", borderRadius: "10px" }, type: "number", id: "territorySelector", name: "territorySelector", min: "0", step: "1", value: props.territory, onInput: function onInput(event) {
	            return props.onInput(event);
	        }, onChange: function onChange(event) {
	            return props.onInput(event);
	        } }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TreeAmountInput = function TreeAmountInput(props) {
	    return React.createElement("div", { className: "rounded card tree-color" }, React.createElement("span", null, "\u041A\u0456\u043B\u044C\u043A\u0456\u0441\u0442\u044C \u0434\u0435\u0440\u0435\u0432: ", React.createElement("strong", null, " ", props.treeAmount)), React.createElement("input", { style: { borderStyle: "unset", borderRadius: "10px" }, type: "number", id: "treeAmountSelector", name: "treeAmountSelector", min: "0", step: "1", value: props.treeAmount, onInput: function onInput(event) {
	            return props.onInput(event);
	        }, onChange: function onChange(event) {
	            return props.onInput(event);
	        } }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WaterAmountInput = function WaterAmountInput(props) {
	    return React.createElement("div", { className: "rounded card water-color" }, React.createElement("span", null, "\u041F\u043B\u043E\u0449\u0430 \u0432\u043E\u0434\u043E\u0439\u043C\u0438\u0449: ", React.createElement("strong", null, " ", props.waterAmount, " \u043A\u043C\xB2")), React.createElement("input", { style: { borderStyle: "unset", borderRadius: "10px" }, type: "number", id: "waterAmountSelector", name: "waterAmountSelector", min: "0", step: "1", value: props.waterAmount, onInput: function onInput(event) {
	            return props.onInput(event);
	        }, onChange: function onChange(event) {
	            return props.onInput(event);
	        } }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var saturationVaporDensityTable_1 = __webpack_require__(210);
	...
	exports.countWaterVolume = function (waterAmount) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var React = __webpack_require__(2);
	var functions_1 = __webpack_require__(206);
	...
	var WaterAmountInput_1 = __webpack_require__(205);
	...
	var HALF_DESERT_HUMIDIFICATION_INDEX = 0.5;
	var STEPPE_HUMIDIFICATION_INDEX = 1;
	var FOREST_STEPPE_HUMIDIFICATION_INDEX = 1.3;
	...
	var MAX_AMOUNT_OF_TREES_PER_ONE_KM2 = 27777;
	...
	var default_1 = function (_React$Component) {
	    ...
	    function default_1(props, context) {
	        ...
	        _this.countVolatility = _asyncToGenerator(function* () {
	            ...
	            return yield Math.max(0.01 * Math.pow(addedAverageTemperature, 2) * (100 - (yield _this.countRelativeHumidity())), 1); // volatility http://meteorologist.ru/formula-isparyaemosti-ivanova.html
	        });
	        _this.countWaterIncome = function () {
	            return Number(_this.state.precipation) + 1000 * (Number(_this.state.additionalWatering) / Number(_this.state.territory)) - Number(_this.state.waterAmount) * functions_1.waterVaporizingCoefficient(Number(_this.state.averageTemperature)) / (Number(_this.state.territory) * 1000000000);
	        };
	        ...
	        _this.countHumidificationIndex = function () {
	            return _this.state.waterIncome / _this.state.volatility; // (precipation + extra water) / volatility
	        };
	        _this.getRiskCategory = function () {
	            var humidificationIndex = _this.countHumidificationIndex();
	            var riskCategory = "";
	            if (_this.state.averageTemperature < 1) {
	                riskCategory = "cold-desert";
	            }
	            if (_this.state.averageTemperature >= 1 && _this.state.averageTemperature < 40) {
	                ...
	                if (humidificationIndex > STEPPE_HUMIDIFICATION_INDEX && humidificationIndex <= FOREST_STEPPE_HUMIDIFICATION_INDEX) {
	                    if (_this.state.averageTemperature <= 9) {
	                ...
	                if (humidificationIndex > FOREST_STEPPE_HUMIDIFICATION_INDEX) {
	                    if (_this.state.averageTemperature > 22) {
	                        riskCategory = "rainforest";
	                    }
	                    if (_this.state.averageTemperature > 9 && _this.state.averageTemperature <= 22) {
	                        riskCategory = "forest";
	                    }
	                    if (_this.state.averageTemperature <= 9) {
	            ...
	            if (_this.state.averageTemperature >= 40) {
	                riskCategory = "desert";
	            }
	            return riskCategory;
	        };
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        var riskCategory = this.getRiskCategory();
	        return React.createElement("div", null, React.createElement("div", { className: "background-image cold-desert", style: { opacity: riskCategory === "cold-desert" ? 1 : 0 } }), React.createElement("div", { className: "background-image desert", style: { opacity: riskCategory === "desert" ? 1 : 0 } }), React.createElement("div", { className: "background-image half-desert", style: { opacity: riskCategory === "half-desert" ? 1 : 0 } }), React.createElement("div", { className: "background-image steppe", style: { opacity: riskCategory === "steppe" ? 1 : 0 } }), React.createElement("div", { className: "background-image forest-steppe", style: { opacity: riskCategory === "forest-steppe" ? 1 : 0 } }), React.createElement("div", { className: "background-image cold-forest-steppe", style: { opacity: riskCategory === "cold-forest-steppe" ? 1 : 0 } }), React.createElement("div", { className: "background-image rainforest", style: { opacity: riskCategory === "rainforest" ? 1 : 0 } }), React.createElement("div", { className: "background-image forest", style: { opacity: riskCategory === "forest" ? 1 : 0 } }), React.createElement("div", { className: "background-image wetland", style: { opacity: riskCategory === "wetland" ? 1 : 0 } }), React.createElement(Header_1.default, { riskCategory: riskCategory }), React.createElement("h1", null, "\u0412\u0432\u0435\u0434\u0435\u043D\u043D\u044F \u0434\u0430\u043D\u0438\u0445"), React.createElement("div", { className: "group-of-cards" }, React.createElement(TerritoryInput_1.default, { territory: this.state.territory, onInput: function onInput(event) {
	                _this2.setState({ territory: Number(event.target.value) });
	                if (Number(event.target.value) < _this2.state.waterAmount) {
	                ...
	                _this2.setState({ waterAmount: Number(event.target.value) });
	                if (Number(event.target.value) > _this2.state.territory) {
	                    _this2.setState({ territory: Number(event.target.value) });
	                }
	                _this2.setCountedResults();
	                ...
	                _this2.setCountedResults();
	            } })), React.createElement("h1", null, "\u041F\u0456\u0434\u0440\u0430\u0445\u043E\u0432\u0430\u043D\u0456 \u043F\u0440\u043E\u043C\u0456\u0436\u043D\u0456 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u0438"), React.createElement("div", { className: "group-of-cards" }, React.createElement(RelativeHumidity_1.default, { relativeHumidity: this.state.relativeHumidity }), React.createElement(AbsoluteHumidity_1.default, { absoluteHumidity: this.state.absoluteHumidity }), React.createElement(Volatility_1.default, { volatility: this.state.volatility }), React.createElement(WaterIncome_1.default, { waterIncome: this.state.waterIncome }), React.createElement(HumidificationIndex_1.default, { humidificationIndex: this.countHumidificationIndex() })), React.createElement("div", { className: "moderate" }), React.createElement("div", { className: "rain" }));
	    };
...
//# sourceMappingURL=component---src-pages-index-tsx-66fdb409f2308f528955.js.map