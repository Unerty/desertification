	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        if (this.state.averageTemperature < 1) {
	            ...
	            return React.createElement("div", { className: "" }, React.createElement("h1", null, "Input Data"), React.createElement("div", { className: "group-of-cards" }, React.createElement(TerritoryInput_1.default, { territory: this.state.territory, onInput: function onInput(event) {
...
//# sourceMappingURL=component---src-pages-index-tsx-1059b156d6954550904f.js.map